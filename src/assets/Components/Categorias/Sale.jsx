...
const Sales = () => {
  ...
  const hombreCategoria = data.categorias?.find(
    (categoria) => categoria.nombre === "Sales"
  );
  ...
  if (!hombreCategoria) {
    return <div>No se encontraron productos para la categoría "Sales"</div>;
  }
          ...
          <div className="" key={producto.id}>
            <div className="flex flex-col h-full rounded-md rounded-b-none">
              ...
              <div className="bg-white text-center text-slate-950 p-4 rounded-md rounded-t-none">
                ...
                <button
                  className="bg-slate-950 text-white border rounded-md shadow-xl px-2 py-1.5 mt-3 hover:scale-105"
